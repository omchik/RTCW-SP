...
typedef struct {
	...
	bool cueZombieSpirit;               // if this is qfalse, and the zombie effect flag is set, then we need to start a new attack
	...
	// Zombie death effect
	// !!FIXME: these effects will be restarted by a *_restart command, can we save this data somehow?
	bool cueZombieDeath;            // if this is qfalse, and the zombie effect flag is set, then we need to start a new attack
