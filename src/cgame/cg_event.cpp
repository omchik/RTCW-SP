...
void CG_Explodef( vec3_t origin, vec3_t dir, int mass, int type, qhandle_t sound, int forceLowGrav, qhandle_t shader, int parent, bool damage ) {
	...
	for ( i = 0; i < POSSIBLE_PIECES; i++ ) {
		leBounceSoundType_t snd = leBounceSoundType_t::LEBS_NONE;
		int hmodel = 0;
		float scale;
		int endtime;
		for ( howmany = 0; howmany < pieces[i]; howmany++ ) {
			...
			switch ( type ) {
			case 0: // "wood"
				snd = leBounceSoundType_t::LEBS_WOOD;
			...
			case 1: // "glass"
				snd = leBounceSoundType_t::LEBS_NONE;
				if ( i == 5 ) {
			...
			case 2: // "metal"
				snd = leBounceSoundType_t::LEBS_BRASS;
				if ( i == 5 ) {
			...
			case 3: // "gibs"
				snd = leBounceSoundType_t::LEBS_BLOOD;
				if ( i == 5 ) {
			...
			case 4: // "brick"
				snd = leBounceSoundType_t::LEBS_ROCK;
			...
			if ( snd == leBounceSoundType_t::LEBS_ROCK && damage ) {
				snd = leBounceSoundType_t::LEBS_NONE;
				if ( damage ) {
